...
const Dashboard = () => {
  ...
  return (
    <div className={`h-screen grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 grid-rows-8 md:grid-rows-7 xl:grid-rows-5 auto-rows-fr gap-6 p-10 font-archivo ${darkMode ? 'bg-gray-900 text-gray-300' : 'bg-neutrtal-100'}`}>
